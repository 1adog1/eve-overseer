			...
			<div class="col-md-3">
				...
				<form class="log_filter" id="custom_filter" method="post" action="/logView/">
					<div class="form-group">
						...
						<div class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input" name="checker_errors" value="true" id="checker_errors" <?php echo (isset($_POST["checker_errors"]) and $_POST["checker_errors"] == "true") ? ("checked") : (""); ?> > 
							<label class="custom-control-label" for="checker_errors">Checker Errors</label>
						</div>
                        
						<div class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input" name="cronjob" value="true" id="cronjob" <?php echo (isset($_POST["cronjob"]) and $_POST["cronjob"] == "true") ? ("checked") : (""); ?> > 
							<label class="custom-control-label" for="cronjob">Cronjob</label>
						</div>
                        
						<div class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input" name="tracking" value="true" id="tracking" <?php echo (isset($_POST["tracking"]) and $_POST["tracking"] == "true") ? ("checked") : (""); ?> > 
